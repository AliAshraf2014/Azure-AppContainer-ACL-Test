#!/usr/bin/env python3
"""
Recursively read ACL for all files on the read-only Azure Data Lake (Gen2) container.
"""
...
def read_all_acls(
    ...
    """Walk every folder under root_path and return ACL for each file."""
...
def main() -> int:
    ...
    print(f"\nDone. Files: {len(results)}, errors: {errors}")
